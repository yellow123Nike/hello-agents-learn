...
# reflection
    ...
    反思 (Reflection)：“评审员”会审视第一步生成的“初稿”，并从多个维度进行评估,如事实性错误、逻辑漏洞、效率问题、遗漏信息
    优化：智能体将“初稿”和“反馈”作为新的上下文，再做一次修正
    reflection机制是如何驱动智能体进行深度优化的:1.有效的“批判”是优化的前提2.迭代式改进3.收敛与终止
    具体实现思路：
